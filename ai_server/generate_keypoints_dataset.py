...
def extract_keypoints_from_video(video_path, output_folder):
    ...
    label = video_name.split("_")[0]  # 예: twohand_001 → twohand
...
input_folder = os.path.join(base_path, "AI", "Data", "Learning")
output_folder = os.path.join(base_path, "AI", "Data", "output_npy")
os.makedirs(output_folder, exist_ok=True)

# ✅ .MOV 및 .mov 파일 모두 검색
video_files = glob(os.path.join(input_folder, "*/*.MOV")) + glob(os.path.join(input_folder, "*/*.mov"))
